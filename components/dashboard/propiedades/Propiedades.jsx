  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        //const response = await fetch(`/api/dashboard/propiedades?tipo=mis-propiedades`, { cache: 'no-store' });
        //const response = await fetch(`/api/dashboard/propiedades?tipo=propiedades-grupo`, { cache: 'no-store' });
        const response = await fetch(`/api/dashboard/propiedades`, { cache: 'no-store' });
        ...
        >
          <div className="thumb">
            ...
            <div className="thmb_cntnt">
              ...
              <Link
                href={`/dashboard/propiedades/propiedad-detalles/1`}
                className="fp_price"
              >
                ${item.Precio}
                <small></small>
          ...
          <div className="details">
            <div className="tc_content">
              ...
              <h4>
                <Link href="/dashboard/propiedades/propiedad-detalles/1">
                  {item.Titulo}
                </Link>
              </h4>
              <p>
