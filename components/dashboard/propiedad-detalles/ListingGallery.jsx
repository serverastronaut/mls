            ...
            <div className="row mb20">
              <div className="col-lg-7 col-xl-8">
                <div className="single_property_title mt30-767">
                  <span>Alquiler</span>
                  <h2>Departamento en Carlos Paz</h2>
                  <p>Calle Ejemplo 123, Carlos Paz | <strong style={{fontDecoration: 'underline'}}>Inmobiliaria XX</strong></p>
                </div>
              </div>
                  ...
                  <div className="spss style2 mt20 text-end tal-400">
                    <ul className="mb0">
                      <li className="list-inline-item">
                        <a href="#" title="Marcar como favorito">
